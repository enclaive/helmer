...
export default function Template(props: TemplateProps<KcContext & { realm: any }, I18n>) {
    const { kcContext, i18n, doUseDefaultCss, active, classes, children } = props;

    const urlConfig = JSON.parse(kcContext?.realm?.displayNameHtml || '{}');
            ...
            <header className="navbar navbar-default navbar-pf navbar-main header">
                <nav className="navbar" role="navigation">
                    <div className="navbar-header">
                        <a style={{ textDecoration: "none", color: "inherit" }} href={urlConfig.frontendUrl}><Logo className="logo" /></a>
                    </div>
                                ...
                                <li className="avatar-li">
                                    <div className="kc-dropdown" id="kc-locale-dropdown">
                                        ...
                                        <div className="avatar">
                                            <div>{kcContext.account.firstName[0]}{kcContext.account.lastName?.[0] || ''}</div>
                                        </div>
                                        <ul>
                                            <li key='create-team' className="kc-dropdown-item">
                                                <a href={`${urlConfig.frontendUrl}/create-team`}>Create Team</a>
                                            </li>
                                            <li key='sign-out' className="kc-dropdown-item">
                                                <a href={kcContext.url.logoutUrl}>Sign Out</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
