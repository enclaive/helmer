...
helm upgrade --install redis ./charts/redis \
  --namespace "$NAMESPACE" \
  --create-namespace \
  --values ./charts/redis/environments/values.staging.yaml \
...
helm upgrade --install admin ./charts/admin \
  --namespace "$NAMESPACE" \
  --create-namespace \
  --values ./charts/admin/environments/values.staging.yaml \
...
helm upgrade --install backend ./charts/backend \
  --namespace "$NAMESPACE" \
  --create-namespace \
  --values ./charts/backend/environments/values.staging.yaml \
